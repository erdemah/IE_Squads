...
d3.csv("datasets/about_your_pay/vic_categ_salary.csv", type, function(data){
    ...
    var circles_vic = g_vic.selectAll(".vic_circle").data(data);
...
d3.csv("datasets/about_your_pay/qld_categ_salary.csv", type, function(data){
    var salary_categ = new Array(data.length);
    for(var i=0; i<data.length;i++){
        salary_categ[i] = data[i]["avg_salary"];
    }
...
qld_treemap_legend.append("rect")
    ...
    .attr("height", qld_legend_h);
//LEGEND FOR TREEMAP END --------------
d3.csv("datasets/about_your_pay/job_post_qld.csv", type, function(data){
    var job_post_array = new Array(data.length);
    for(var i=0; i<data.length;i++){
        if(data[i]["job_post"] == ""){
            continue;
...
d3.csv("datasets/about_your_pay/nsw_categ_salary.csv", type, function(data){
    var salary_categ = new Array(data.length);
    for(var i=0; i<data.length;i++){
        salary_categ[i] = data[i]["avg_salary"];
    }
...
nsw_treemap_legend.append("rect")
    ...
    .attr("height", nsw_legend_h);
//LEGEND FOR TREEMAP END --------------
d3.csv("datasets/about_your_pay/job_post_nsw.csv", type, function(data){
//    //reversing color
//    var my_color = d3.schemeSpectral[11];
//    my_color.sort(function(a,b){
//        return b-a;
